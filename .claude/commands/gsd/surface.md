...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/nguyenvietloc/Documents/investing/.claude/.gsd-surface.json`
(sibling to `/Users/nguyenvietloc/Documents/investing/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/nguyenvietloc/Documents/investing/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/nguyenvietloc/Documents/investing/.claude/skills`).
...
`/Users/nguyenvietloc/Documents/investing/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/nguyenvietloc/Documents/investing/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/nguyenvietloc/Documents/investing/.claude/.gsd-surface.json`
Install profile marker: `/Users/nguyenvietloc/Documents/investing/.claude/.gsd-profile`
Skill dirs: `/Users/nguyenvietloc/Documents/investing/.claude/skills/gsd-*/`
Engine module: `/Users/nguyenvietloc/Documents/investing/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/nguyenvietloc/Documents/investing/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
