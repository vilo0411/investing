...
```
Agent(
  prompt="Read /Users/nguyenvietloc/Documents/investing/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/nguyenvietloc/Documents/investing/.claude/gsd-core/templates/VALIDATION.md`
