...
<required_reading>
@/Users/nguyenvietloc/Documents/investing/.claude/gsd-core/references/ai-frameworks.md
@/Users/nguyenvietloc/Documents/investing/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/nguyenvietloc/Documents/investing/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/nguyenvietloc/Documents/investing/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/nguyenvietloc/Documents/investing/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/nguyenvietloc/Documents/investing/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/nguyenvietloc/Documents/investing/.claude/agents/gsd-eval-planner.md for instructions.
