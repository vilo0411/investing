...
- Usage: Reference from command with `@/Users/nguyenvietloc/Documents/investing/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/nguyenvietloc/Documents/investing/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/nguyenvietloc/Documents/investing/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
