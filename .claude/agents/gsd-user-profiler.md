...
<reference>
@/Users/nguyenvietloc/Documents/investing/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/nguyenvietloc/Documents/investing/.claude/gsd-core/references/user-profiling.md` to load:
