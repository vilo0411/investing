...
```
Agent(
  prompt="Read /Users/nguyenvietloc/Documents/investing/.gemini/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/nguyenvietloc/Documents/investing/.gemini/gsd-core/templates/SECURITY.md`
