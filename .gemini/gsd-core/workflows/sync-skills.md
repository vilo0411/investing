...
INSTALL_JS_GLOBAL="/Users/nguyenvietloc/Documents/investing/.gemini/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/nguyenvietloc/Documents/investing/.gemini/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
