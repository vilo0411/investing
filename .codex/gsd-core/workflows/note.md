...
- **Global scope**: `/Users/nguyenvietloc/Documents/investing/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/nguyenvietloc/Documents/investing/.codex/notes/`)
...
2. Glob `/Users/nguyenvietloc/Documents/investing/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/nguyenvietloc/Documents/investing/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/nguyenvietloc/Documents/investing/.codex/notes/` — works in any directory
