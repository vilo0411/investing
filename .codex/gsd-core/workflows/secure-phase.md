...
```
Agent(
  prompt="Read /Users/nguyenvietloc/Documents/investing/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/nguyenvietloc/Documents/investing/.codex/gsd-core/templates/SECURITY.md`
